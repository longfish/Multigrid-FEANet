function [K, f_o, f, d, mesh] = laplace
...
A = K_F;
b = f_F - K_EF' * d_E;
[d_F, error_arr] = jacobi_method(A, b, zeros(length(b),1), 20000);
...
save('laplace_xy.mat','u','error_arr');

vtkwrite('laplace_xy.vtk', 'structured_points', 'u', u);
